TARGET_BOARD_INFO_FILE := device/nexell/lepus/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := lepus
...
# opengl
BOARD_EGL_CFG := device/nexell/lepus/egl.cfg
...
WIFI_DRIVER_MODULE_ARG		:= "iface_name=wlan0 firmware_path=/system/etc/firmware/fw_bcmdhd.bin nvram_path=/system/etc/firmware/nvram.txt"
# ddanggzi -- end
endif
