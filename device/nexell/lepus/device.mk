...
################################################################################
#PRODUCT_COPY_FILES += \
	device/nexell/lepus/boot/2ndboot.bin:2ndbootloader
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/lepus/init.lepus.rc:root/init.lepus.rc \
	device/nexell/lepus/init.lepus.usb.rc:root/init.lepus.usb.rc \
	device/nexell/lepus/init.recovery.lepus.rc:root/init.recovery.lepus.rc \
	device/nexell/lepus/fstab.lepus:root/fstab.lepus \
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/lepus/keypad_lepus.kl:system/usr/keylayout/keypad_lepus.kl \
	device/nexell/lepus/keypad_lepus.kcm:system/usr/keychars/keypad_lepus.kcm

################################################################################
# touch
################################################################################
PRODUCT_COPY_FILES += \
    device/nexell/lepus/gslX680.idc:system/usr/idc/gslX680.idc
...
################################################################################
#PRODUCT_COPY_FILES += \
	#device/nexell/lepus/vold.fstab:system/etc/vold.fstab
...
# mixer paths
PRODUCT_COPY_FILES += \
	device/nexell/lepus/audio/tiny_hw.lepus.xml:system/etc/tiny_hw.lepus.xml
# audio policy configuration
PRODUCT_COPY_FILES += \
	device/nexell/lepus/audio/audio_policy.conf:system/etc/audio_policy.conf

################################################################################
# media, camera
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/lepus/media_codecs.xml:system/etc/media_codecs.xml \
	device/nexell/lepus/media_profiles.xml:system/etc/media_profiles.xml
...
PRODUCT_COPY_FILES += \
	hardware/kant/wifi/bcmdhd/bcmdhd.ko:system/lib/modules/bcmdhd.ko \
    hardware/kant/mipi_lcd/kant_mipi.ko:system/lib/modules/kant_mipi.ko
...
################################################################################
#PRODUCT_COPY_FILES += \
  #device/nexell/lepus/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
# Added by ddanggzi
PRODUCT_COPY_FILES += \
	hardware/broadcom/libbt/conf/ap6210/bcm43438a0.hcd:system/etc/bluetooth/bcm43438a0.hcd \
	hardware/broadcom/libbt/conf/ap6210/bd_addr.txt:system/etc/firmware/bd_addr.txt \
	hardware/broadcom/libbt/conf/ap6210/bt_vendor.conf:system/etc/bluetooth/bt_vendor.conf
# dddanggzi -- end
# bluetooth
# wifi
# Added by ddanggzi
...
PRODUCT_COPY_FILES += \
	device/nexell/lepus/bcmdhd/fw_bcmdhd.bin:system/etc/firmware/fw_bcmdhd.bin \
	device/nexell/lepus/bcmdhd/fw_bcmdhd_apsta.bin:system/etc/firmware/fw_bcmdhd_apsta.bin \
	device/nexell/lepus/bcmdhd/fw_bcmdhd_p2p.bin:system/etc/firmware/fw_bcmdhd_p2p.bin \
	device/nexell/lepus/bcmdhd/nvram.txt:system/etc/firmware/nvram.txt \
