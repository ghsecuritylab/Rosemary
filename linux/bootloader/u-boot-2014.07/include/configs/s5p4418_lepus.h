...
#define CONFIG_PMIC
		...
		#define	CFG_IO_I2C0_SCL	((PAD_GPIO_D + 20) | PAD_FUNC_ALT0)
        #define	CFG_IO_I2C0_SDA	((PAD_GPIO_D + 16) | PAD_FUNC_ALT0) 
...
#define CONFIG_ENV_IS_IN_MMC
    ...
    #define CONFIG_MMC0_CLK_DELAY       DW_MMC_DRIVE_DELAY(0x3f) | DW_MMC_SAMPLE_DELAY(0x7f) | DW_MMC_DRIVE_PHASE(2)| DW_MMC_SAMPLE_PHASE(0)
