...
static int lcd_set_vsync(struct disp_process_dev *pdev, struct disp_vsync_info *psync)
{
	...
	printk("999999999999999999999999999999999999999999999999991\r\n");
...
static int  lcd_prepare(struct disp_process_dev *pdev)
{
	...
	int rsc = 0, sel = 0;
	 printk("999999999999999999999999999999999999999999999999992\r\n");
...
static int  lcd_enable(struct disp_process_dev *pdev, int enable)
{
    ...
    printk("999999999999999999999999999999999999999999999999993\r\n");
	if (! enable) {
...
{
	CBOOL ret = CFALSE;
    printk("999999999999999999999999999999999999999999999999994\r\n");
	switch (pdev->dev_in) {
