...
#define BCM43436B0_CONF_NAME "config_43436b0.txt"
...
#define MACS "%02x%02x%02x%02x%02x%02x"
	 ...
	 * magic_pkt_filter_add=141 0 1 12
	 */
...
dhd_conf_preinit(dhd_pub_t *dhd)
{
	...
	if (conf->chip == BCM43430_CHIP_ID) {
		conf->tx_max_offset = 1; // terence 20161011: fix credict issue in adaptivity testing
	}
#endif
