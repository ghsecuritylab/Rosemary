...
ft5x0x_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    // Added by ddanggzi
	nxp_soc_gpio_set_io_dir(CFG_IO_TOUCH_RESET_PIN, 1);		
	
    nxp_soc_gpio_set_io_func(CFG_IO_TOUCH_RESET_PIN, NX_GPIO_PADFUNC_0);
    ...
    TS_DEBUG("SCREEN_MAX_X = %d, SCREEN_MAX_Y = %d\r\n", SCREEN_MAX_X, SCREEN_MAX_Y);
