...
protected:
  // Timeval(time_base_seconds seconds, time_base_seconds useconds) { // by doriya
  //   fTv.tv_sec = seconds; fTv.tv_usec = useconds;
  // }
  Timeval(time_base_seconds sec, time_base_seconds usec) {
    fTv.tv_sec = sec; fTv.tv_usec = usec;
  }
...
public:
  // DelayInterval(time_base_seconds seconds, time_base_seconds useconds) // by doriya
  //   : Timeval(seconds, useconds) {}
  DelayInterval(time_base_seconds sec, time_base_seconds usec)
    : Timeval(sec, usec) {}
};
