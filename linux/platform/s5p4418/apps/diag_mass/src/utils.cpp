...
{
	SDL_FillRect( surface, rect, color );
	bresenham_line( surface, rect->x          , rect->y          , rect->x+rect->w-1, rect->y          , lineColor );
	bresenham_line( surface, rect->x          , rect->y+rect->h-1, rect->x+rect->w-1, rect->y+rect->h-1, lineColor );
	bresenham_line( surface, rect->x          , rect->y          , rect->x          , rect->y+rect->h-1, lineColor );
	bresenham_line( surface, rect->x+rect->w-1, rect->y          , rect->x+rect->w-1, rect->y+rect->h-1, lineColor );
}
